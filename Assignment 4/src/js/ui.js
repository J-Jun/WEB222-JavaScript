...
function updateTableTitle(title) {
  var tableTitle = document.querySelector("#table-title span");
...
function clearAllTableRows() {
  var clearTable = document.getElementById("rows");

  if (clearTable.hasChildNodes()) clearTable.innerHTML = "";
}
...
function createAnchor(href, innerContent) {
  ...
  anchorElement.appendChild(innerContent);
