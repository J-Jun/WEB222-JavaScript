...
function toggleLoading(isLoading) {
  ...
  search_toggle = document.querySelector("#searchButton");

  if (isLoading) {
    search_toggle.disabled = true;
    search_toggle.innerHTML =
      '<i class="fas fa-hourglass-half"></i> Loading...</button>';
  } else {
    search_toggle.disabled = false;
    search_toggle.innerHTML = '<i class="fas fa-search"></i> Search</button>';
  }
}
